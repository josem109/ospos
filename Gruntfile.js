module.exports = function (grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          ...
          },
          {
            ...
            rename: function (dest, src) {
              return dest + src.replace("LICENSE", "bootstrap-5.license");
            },
            filter: "isFile",
          },
          {
            ...
            dest: "public/license/",
            rename: function (dest, src) {
              return dest + src.replace("LICENSE", "bootswatch-5.license");
            },
            filter: "isFile",
          },
        ],
    ...
    concat: {
      js: {
        ...
        files: {
          "tmp/opensourcepos.js": [
            "public/dist/jquery/jquery.js",
            "tmp/opensourcepos_bower.js",
            "public/js/*.js",
          ],
        },
      },
    ...
    uglify: {
      options: {
        banner:
          '/*! opensourcepos <%= grunt.template.today("dd-mm-yyyy") %> */\n',
      },
      dist: {
        files: {
    ...
    tags: {
      ...
      js: {
        ...
        src: [
          "public/dist/bootstrap/js/*.min.js",
          "public/js/jquery*",
          "public/js/*.js",
        ],
        dest: "application/views/partial/header.php",
  ...
  grunt.registerTask("genlicense", [
    "clean:license",
    "license",
    "bower-licensechecker",
  ]);
  grunt.registerTask("package", ["default", "compress", "cssmin"]);
